...
class ResNetV2(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        assert block in (BottleneckV2, BasicBlockV2), \
            "Argument block should be BottleneckV2 or BasicBlockV2"
        self.inplanes = 64

        # See https://github.com/apache/incubator-mxnet/blob/master/python/mxnet/gluon/model_zoo/vision/resnet.py#L308
        # and https://mxnet.incubator.apache.org/api/python/gluon/nn.html?mxnet.gluon.nn.BatchNorm#mxnet.gluon.nn.BatchNorm
        self.bn0 = nn.BatchNorm2d(3, affine=False, track_running_stats=False)
        ...
        for m in self.modules():
            ...
            elif isinstance(m, nn.BatchNorm2d) and m != self.bn0:
