...
OUTPUT_PATH = Path("output") / "test_probas" / "cv" / "nasnetlarge_350_resized_crop"
...
MODEL = (Path("output") / "cv" / "nasnetlarge_350_resized_crop" / "fold_1" / "20180526_1547" /
         "model_FurnitureNASNetALarge350_5_val_loss=0.5232775.pth").as_posix()
