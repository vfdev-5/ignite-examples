...
OUTPUT_PATH = Path("output") / "test_probas"
...
MODEL = (Path("output") / "train" / "train_inceptionv4_350_cls_wts_adam_resized_crop" / "20180520_0822" /
         "model_FurnitureInceptionV4_350_11_val_loss=0.6985032.pth").as_posix()
