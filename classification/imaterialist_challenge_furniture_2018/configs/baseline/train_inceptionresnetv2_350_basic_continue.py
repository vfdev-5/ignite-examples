...
model_checkpoint = (Path(OUTPUT_PATH) / "training_FurnitureInceptionResNet350_20180418_0838" /
                    "model_FurnitureInceptionResNet299_3_val_loss=0.5987867.pth").as_posix()
...
REDUCE_LR_ON_PLATEAU = ReduceLROnPlateau(OPTIM, mode='min', factor=0.5, patience=3, threshold=0.05, verbose=True)
