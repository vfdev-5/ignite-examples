...
from models.inceptionresnetv2_ssd_like import FurnitureInceptionResNetV4350SSDLike_v2
...
MODEL = FurnitureInceptionResNetV4350SSDLike_v2(num_classes=128, pretrained='imagenet')
...
OPTIM = RMSprop(
    params=[
        ...
        {"params": MODEL.inner_classifier.parameters(), 'lr': 0.045},
