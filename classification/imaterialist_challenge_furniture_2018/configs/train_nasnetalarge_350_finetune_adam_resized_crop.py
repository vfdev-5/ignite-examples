...
from models.nasnet_a_large import FurnitureNASNetALarge350Finetunned
...
MODEL = FurnitureNASNetALarge350Finetunned(pretrained='imagenet')
...
OPTIM = Adam(
    params=[
        ...
        {"params": MODEL.final_classifier.parameters(), 'lr': 0.001},
    ],
)
